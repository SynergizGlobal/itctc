...
@Entity
@Table(name = "cam_measurement_header")

public class CamMeasurementHeader {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "cam_measurement_header_id")
	...
	public List<CamMeasurementDetail> getDetails() {
		return details;
	}

	public void setDetails(List<CamMeasurementDetail> details) {
    ...
    @OneToMany(
            mappedBy = "camMeasurementHeader",
            cascade = CascadeType.ALL,
            orphanRemoval = true,
            fetch = FetchType.LAZY
    )
    private List<CamMeasurementDetail> details = new ArrayList<>();
}