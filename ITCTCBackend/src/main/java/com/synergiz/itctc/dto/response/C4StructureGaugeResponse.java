...
public class C4StructureGaugeResponse {
	...
	private List<C4StructureGaugeDetailResponse> details;
	...
	public List<C4StructureGaugeDetailResponse> getDetails() {
		return details;
	}

	public void setDetails(List<C4StructureGaugeDetailResponse> details) {
