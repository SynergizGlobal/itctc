...
public class C2FormationWidthTunnelRequest {
    ...
    private List<C2FormationWidthTunnelDetailRequest> details;
    ...
    public List<C2FormationWidthTunnelDetailRequest> getDetails() {
        return details;
    }

    public void setDetails(
            List<C2FormationWidthTunnelDetailRequest> details) {
