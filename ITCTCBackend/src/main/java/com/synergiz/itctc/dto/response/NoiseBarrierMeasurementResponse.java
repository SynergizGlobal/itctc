...
public class NoiseBarrierMeasurementResponse {
	...
	public List<NoiseBarrierMeasurementDetailResponse> getDetails() {
		return details;
	}

	public void setDetails(List<NoiseBarrierMeasurementDetailResponse> details) {
