...
const gaps = [75, 72, 74, 76, 73, 71, 75, 74, 72, 76, 73, 75, 71, 74, 73];
const railTemps = [38, 39, 37, 40, 38, 41, 39, 38, 40, 37, 39, 38, 41, 40, 39];
...
<button type="button" onClick={() => navigate(-1)} title="Back" style={{ border: 'none', background: 'transparent', padding: 0, cursor: 'pointer' }}><ArrowLeft aria-hidden="true" /></button>
        ...
        <span>No. <input type="text" defaultValue="T121-001" className="d-inline-block" style={{ width: '60px', border: 'none', borderBottom: '1px solid #000', textAlign: 'center', background: 'transparent', outline: 'none' }} /></span>
        ...
        <table className="table table-bordered table-striped table-sm align-middle form-table export-table mb-0" border="1">
          <thead>
            <tr>
              ...
              <th width="130" rowSpan="2">Expansion Joint Gap<br />(mm)</th>
