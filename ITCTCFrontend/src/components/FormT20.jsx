...
const intervalValues = [600, 602, 598, 601, 599, 603, 600, 601, 598, 602, 600, 599, 603, 601, 598, 600, 602, 599, 601, 600];
const squarenessValues = [2, 3, 2, 1, 3, 2, 2, 1, 3, 2, 1, 2, 3, 2, 1, 2, 3, 2, 1, 2];
...
function measurementRow(index) {
  return [
    ...
    squarenessValues[index],
    '',
  ];
}

export default function FormT20() {
...
<button type="button" onClick={() => navigate(-1)} title="Back" style={{ border: 'none', background: 'transparent', padding: 0, cursor: 'pointer' }}><ArrowLeft aria-hidden="true" /></button>
        <h1 className="h6 mb-0">Form T-20</h1>
        <span className="title-main text-center flex-grow-1 mx-3">Measurement record of Sleeper's interval and squareness</span>
        <span>No. <input type="text" defaultValue="T20-001" className="d-inline-block" style={{ width: '60px', border: 'none', borderBottom: '1px solid #000', textAlign: 'center', background: 'transparent', outline: 'none' }} /></span>
        ...
        <div className="form-export-actions">
          ...
          <button type="button" onClick={() => downloadExcel('Form-T-20.xls')} title="Download as Excel"><i className="fa-solid fa-file-excel" /></button>
        </div>
      </div>
        ...
        <table className="table table-bordered table-striped table-sm align-middle form-table export-table mb-0" border="1">
          <thead>
            <tr>
              ...
              <th width="90" rowSpan="2">Sleeper No.</th>
              <th colSpan="2">Chainage</th>
              <th width="130" rowSpan="2">Sleeper Interval<br />(mm)</th>
              <th width="130" rowSpan="2">Squareness<br />(mm)</th>
