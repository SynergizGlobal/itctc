...
const torqueValues = [150, 148, 152, 149, 151, 147, 153, 150, 149, 151, 148, 152, 150, 149, 151, 147, 152, 150];
...
<button type="button" onClick={() => navigate(-1)} title="Back" style={{ border: 'none', background: 'transparent', padding: 0, cursor: 'pointer' }}><ArrowLeft aria-hidden="true" /></button>
        ...
        <span className="title-main text-center flex-grow-1 mx-3">Measurement record of Rail Fasteners for Slab Track (Directly-laid type 8, improved and low)</span>
        <span>No. <input type="text" defaultValue="T61-001" className="d-inline-block" style={{ width: '60px', border: 'none', borderBottom: '1px solid #000', textAlign: 'center', background: 'transparent', outline: 'none' }} /></span>
