...
export default function FormT14() {
...
<button type="button" onClick={() => navigate(-1)} title="Back" style={{ border: 'none', background: 'transparent', padding: 0, cursor: 'pointer' }}><ArrowLeft aria-hidden="true" /></button>
        <h1 className="h6 mb-0">Form T-14</h1>
        <span className="title-main text-center flex-grow-1 mx-3">Measurement record of Track centre spacing between tracks</span>
        <span>No. <input type="text" defaultValue="T14-001" className="d-inline-block" style={{ width: '60px', border: 'none', borderBottom: '1px solid #000', textAlign: 'center', background: 'transparent', outline: 'none' }} /></span>
        ...
        <div className="form-export-actions">
          ...
          <button type="button" onClick={() => downloadExcel('Form-T-14.xls')} title="Download as Excel"><i className="fa-solid fa-file-excel" /></button>
        </div>
      </div>
