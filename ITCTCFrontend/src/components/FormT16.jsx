...
const torqueValues = [60, 62, 59, 61, 63, 60, 62, 58, 61, 62, 60, 63, 59, 61, 62, 60, 58, 62, 61, 60];
...
export default function FormT16() {
...
<button type="button" onClick={() => navigate(-1)} title="Back" style={{ border: 'none', background: 'transparent', padding: 0, cursor: 'pointer' }}><ArrowLeft aria-hidden="true" /></button>
        <h1 className="h6 mb-0">Form T-16</h1>
        <span className="title-main text-center flex-grow-1 mx-3">Measurement record of Torque for Fishplate</span>
        <span>No. <input type="text" defaultValue="T16-001" className="d-inline-block" style={{ width: '60px', border: 'none', borderBottom: '1px solid #000', textAlign: 'center', background: 'transparent', outline: 'none' }} /></span>
        ...
        <div className="form-export-actions">
          ...
          <button type="button" onClick={() => downloadExcel('Form-T-16.xls')} title="Download as Excel"><i className="fa-solid fa-file-excel" /></button>
        </div>
      </div>
        ...
        <table className="table table-bordered table-striped table-sm align-middle form-table export-table mb-0" border="1">
          <thead>
            <tr>
              ...
              <th width="90" rowSpan="2">Bolt No.</th>
